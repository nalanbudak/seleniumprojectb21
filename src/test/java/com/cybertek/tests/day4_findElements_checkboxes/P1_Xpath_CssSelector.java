...
public class P1_Xpath_CssSelector {
    ...
    public static void main(String[] args) {
        ...
        //Locating the same link using class attribute's value====>           //WebElement homeLink = driver.findElement(By.xpath("//a[@class='nav-link']"));
        //Locating the same link using href attribute's value=====>           //WebElement homeLink = driver.findElement(By.xpath("//a[@href='/']"));
